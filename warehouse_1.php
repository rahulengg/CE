...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Suncart">OnlineShopping</a></h1>
				<div id="top-nav">
					<ul>
					<?php
				...
				<div class="shell">
					<div class="carts">
						<ul>
							...
							<li><a href="#" title="OnlineShopping"><img src="images/suncart.png" alt="OnlineShopping" /></a></li>
				
						</ul>
					</div>	<p>&copy; OnlineShopping.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To OnlineShopping Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
					Copyright © 2014 OnlineShopping.com All rights reserved. The information contained in OnlineShopping.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of OnlineShopping.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
