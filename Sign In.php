    ...
    <body>
        ...
        <div class="container">
			...
			<header>
				 ...
				 <h1><p> <a href="Sign In.php"><img src="images/logo.png" alt="" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>OnlineShopping SMART<strong>Login Form</strong> <span>Please Login Or Sign Up </span></p> </h1>
                        ...
                        <div id="login" class="animate form">
                            <form  action="userValidate.php" method="post" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input type="text" name="uname" required="required" type="text" placeholder="abc@gmail.com"/>
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Your Password </label>
                                    <input type="password" name='pwd' required="required" type="password" placeholder="eg. *********" /> 
                                </p>
                                <p class="keeplogin"> 
                        ...
                        <div id="register" class="animate form">
							 ...
							 <form  action="employeeValidate.php" method="post" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input type="text" name="auname" required="required" type="text" placeholder="myusername "/>
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Your Password </label>
                                    <input type="password" name='apwd' required="required" type="password" placeholder="eg. *******" /> 
                                </p>
                                <p class="keeplogin"> 
									<input type="checkbox" name="loginkeeping" id="loginkeeping" value="loginkeeping" /> 
									<label for="loginkeeping">Keep me logged in</label>
